...
public class ConversationUI extends Thread {
    ...
    private final Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            ArrayAdapter adapter = new ArrayAdapter<String>(context,R.layout.activity_listview,aResponse);
    ...
    public void run() {
        while (true) {
            ...
            userMessage u = (userMessage) context.getApplicationContext();
            Message msg = Message.obtain(); // Creates an new Message instance
            String[] temp = new String[u.ordre.length];
            System.out.println(u.ordre[0]);
